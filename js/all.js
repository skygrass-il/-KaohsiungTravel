...
let loader = document.querySelector('.fas');
...
function updatePoint() {
    ...
    for (let i = start - showPnum; i < dataLen; i++) {
        ...
        str += `<div class="point">
                  ...
                  <div class="new">
                     <div><img src="img/icons_clock.png"><span>${nowData[i].Opentime}</span></div>
                     <div><img src="img/icons_pin.png"><span>${nowData[i].Add}</span></div>
                     <img src="img/icons_phone.png"><span>${nowData[i].Tel}</span>
                     <img src="img/icons_tag.png"><span>${strT}</span>
                     </div>
                  </div>`
    }
